...
them out, and use them to generate new love letters.

The web interface includes v1 (static love letter list generated with some
pre-GPT charNN-like solution whose name has been lost), v2 (love letters
generated on the fly with a finetuned ChatGPT model), and "Vibed Love Letters"
(love letters generated by Claude Sonnet, using a random sample of real letters
as style examples in the prompt).
